...
- Workflow:
  ...
  - All submissions (labs, assignments, midterm, and final) through [GitHub](https://github.com/UofUEpi/PHS7045-advanced-programming).

  - Submissions must be using [quarto](https://quarto.org), [Rmarkdown](https://rmarkdown.rstudio.com/), or similar (like [this presentation](https://github.com/UofUEpi/PHS7045-advanced-programming/blob/629f4654a6288a305261b5c7b8e51ddfed354256/lectures/01-git/slides.qmd)!).
...
2. Set-up version git and GitHub (make sure it works).
