...
An R package example of modular programming and anti-bugging: [seqSGPV](https://github.com/chipmanj/SeqSGPV/tree/master/R).
...
# Debug using Rstudio 'Rerun with Debug'
f("a")
...
* Do you have any feedback on how to make the code more readable?
...
Profile your (or a classmate's) warm-up problem solution.
