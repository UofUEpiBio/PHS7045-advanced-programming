...
$$
y_{ij} = X_{ij}\beta_i + \varepsilon_{ij},\quad \varepsilon_{ij} \sim N(0, \sigma^2_i)
$$

$$
\quad\forall \text{ observations } j \in \left\{1, \dots, 500 \right\} \text{ in column } i \in \left\{1, \dots, 999 \right\}
$$
