...
::: {.fragment .fade-up}
- How the class will work (next slide).
:::
...
## A (Very) Short History of Git (cont'd)
...
::: {.fragment .fade-in}
- **Remote**: a copy of your repository somewhere else. It has a short name; by convention the
