...
We will be working with the repository [https://github.com/UofUEpiBio/PHS7045-whoami](https://github.com/UofUEpiBio/PHS7045-whoami). This repository contains a single file, `README.md`, which is a Markdown file that will contain your and your team members' biographies. The goal of this lab is to edit the file and add your biography to it.
...
<figure>
<img src="fig/GitHub_Fork_Button.png" width="400px" alt="GitHub fork button on a repository page">
...
<figure>
<img src="fig/pull-request-compare-pull-request.png" width="600px" alt="GitHub notification showing a recently pushed branch with a Compare and pull request button">
<figcaption>Source: GitHub Help</figcaption>
</figure>
