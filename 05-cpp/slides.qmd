...
- Five canonical parts: a **memory**, a **control unit**, an **arithmetic/logic unit**,
  and **input** and **output**.
- Instructions sit in the same memory as the data. 
:::
:::
...
int main() {
  ...
  for (size_t i = 0u; i < n_sims; ++i)
  {
    ...
    // Is the point inside the unit circle?
    if (d <= 1.0)
      pi_approx += 1.0;
  }
...
#| eval: true
#| results: asis
cat("```cpp", readLines("summary.hpp"), "```", sep = "\n")
```
