...
- [**dtplyr**](https://cran.r-project.org/package=dplyr) in R
...
In C and other languages, strings, integers, and doubles may be specified with size. This is relevant when managing large datasets, where saving space can be fundamental ([more info](https://en.wikipedia.org/wiki/C_data_types#Main_types)).
...
## Python appendix: Loading the data
...
## Python appendix: Selecting columns {.small}
